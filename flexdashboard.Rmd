...
scale_y <- c(seq(0, 2000, 250), seq(2000, 60000, 500))
...
scale_x[scale_x == 0] <- 1
scale_x[scale_x == 10000] <- 9999
scale_y <- c(seq(0, 250, 25), seq(250, 500, 50), seq(500, 2000, 250), seq(2000, 60000, 500))
...
# My BCRC rank/rarity
## Column 1 {data-icon="ion-help-circled"}
### Find your BCRC rank and rarity
```{r}
